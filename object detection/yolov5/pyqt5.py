# # -*- coding: utf-8 -*-
#
# # Form implementation generated from reading ui file 'tsr_qt.ui'
# #
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        parser.add_argument('--source', type=str,
                            default='data/images/test', help='source')
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "交通标志识别"))
    ...
    def button_image_open(self):
        ...
        jpg_nums = len(os.listdir("qt_pred/jpg_pred/"))
        cv2.imwrite('qt_pred/jpg_pred/prediction' + str(jpg_nums + 1) + '.jpg', showimg)
    ...
    def button_video_open(self):
        ...
        if flag == False:
            ...
            video_nums = len(os.listdir("qt_pred/video_pred"))
            self.out = cv2.VideoWriter('qt_pred/video_pred/prediction' + str(video_nums + 1) + '.avi',
